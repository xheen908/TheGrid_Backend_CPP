...
INSERT INTO `characters` (`id`, `user_id`, `char_name`, `character_class`, `map_name`, `pos_x`, `pos_y`, `pos_z`, `rotation`, `level`, `xp`, `hp`, `max_hp`, `mana`, `max_mana`, `last_login`) VALUES
	...
	(134, 2, 'Jheen', 'Mage', 'TestMap0', 31.6409, -0.318834, 33.3376, 3.11, 4, 1455, 284, 564, 188, 608, '2026-02-05 14:26:46');
...
INSERT INTO `player_quests` (`character_id`, `quest_id`, `status`, `progress`) VALUES
	...
	(134, 'skeleton_slayer_1', 'active', '{"18": 5, "19": 4, "20": 5}');
...
INSERT INTO `mobs` (`id`, `mob_id`, `map_name`, `name`, `model_id`, `mob_type`, `level`, `hp`, `pos_x`, `pos_y`, `pos_z`, `rotation_y`, `respawn_time`) VALUES
	(10, '10', 'Dungeon0', 'Neon-Pyramide', 'neon_sphere', 'Boss', 1, 150, 17.5038, 5.10011, 0.152788, 0, 30),
	(11, '11', 'Arena2', 'Neon-Würfel', 'neon_sphere', 'Normal', 1, 150, 0, 2, 5, 0, 15),
	(12, '12', 'Arena2', 'Neon-Kegel', 'neon_sphere', 'Normal', 1, 150, 5, 2, 5, 0, 15),
	(13, '13', 'Arena2', 'Neon-Pyramide', 'neon_sphere', 'Normal', 1, 150, -5, 2, 5, 0, 20),
	(14, '14', 'Arena2', 'Neon-Sphäre', 'neon_sphere', 'Normal', 1, 150, 0, 2, -5, 0, 30),
	(15, '15', 'Arena2', 'Neon-Torus', 'neon_sphere', 'Normal', 1, 150, 5, 2, -5, 0, 45),
	(16, '16', 'Arena2', 'Neon-Kapsel', 'neon_sphere', 'Normal', 1, 150, -5, 2, -5, 0, 20),
	(17, '17', 'Arena2', 'Gigantischer Neon-Ring', 'neon_sphere', 'Normal', 1, 150, 0, 6, 0, 0, 60),
	(18, '18', 'TestMap0', 'Zombie Späher', 'skeleton_rogue', 'Normal', 1, 150, 56.3967, -0.378409, 18.9367, 3.14, 60),
	(19, '19', 'TestMap0', 'Gerfried', 'skeleton_minion', 'Normal', 1, 150, 52.3967, -0.178409, 18.9367, 3.14, 60),
	(20, '20', 'TestMap0', 'Zombie Magier 1', 'skeleton_mage', 'Normal', 1, 150, 65.4555, -1.6628, 24.6979, 3.14, 60),
	(21, '21', 'TestMap0', 'Hartmuth', 'skeleton_mage', 'Normal', 1, 150, 67.4555, -2.6628, 26.6979, 1.57, 60),
	(22, '23', 'TestMap0', 'Günther', 'skeleton_mage', 'Normal', 1, 150, 53.7127, -0.159771, 14.4889, 3.14, 60),
	(23, '20', 'TestMap0', 'Zombie Magier 2', 'skeleton_mage', 'Normal', 1, 150, 51.7127, -0.359771, 14.4889, 4.71, 60),
	(24, '20', 'TestMap0', 'Zombie Magier 3', 'skeleton_mage', 'Normal', 1, 150, 60.0, -1.0, 20.0, 0.0, 60),
	(25, '20', 'TestMap0', 'Zombie Magier 4', 'skeleton_mage', 'Normal', 1, 150, 62.0, -1.0, 22.0, 1.0, 60),
	(26, '20', 'TestMap0', 'Zombie Magier 5', 'skeleton_mage', 'Normal', 1, 150, 64.0, -1.0, 24.0, 2.0, 60),
	(27, '20', 'TestMap0', 'Zombie Magier 6', 'skeleton_mage', 'Normal', 1, 150, 58.0, -1.0, 18.0, 3.0, 60),
	(28, '20', 'TestMap0', 'Zombie Magier 7', 'skeleton_mage', 'Normal', 1, 150, 55.0, -1.0, 15.0, 4.0, 60),
	(29, '20', 'TestMap0', 'Zombie Magier 8', 'skeleton_mage', 'Normal', 1, 150, 50.0, -1.0, 12.0, 5.0, 60),
	(30, '20', 'TestMap0', 'Zombie Magier 9', 'skeleton_mage', 'Normal', 1, 150, 48.0, -1.0, 10.0, 0.5, 60),
	(31, '20', 'TestMap0', 'Zombie Magier 10', 'skeleton_mage', 'Normal', 1, 150, 46.0, -1.0, 8.0, 1.5, 60);
...
INSERT INTO `quests` (`id`, `title`, `description`, `objectives`, `reward_xp_base`, `reward_xp_max`) VALUES
	('skeleton_slayer_1', 'Die Skelett-Bedrohung', 'Töte die Skelette in TestMap0. Gerfried, Hartmuth und Günther müssen fallen!', '{"18": 10, "19": 1, "20": 10, "21": 1, "23": 1}', 750, 40000);
